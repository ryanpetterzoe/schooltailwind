...
<aside class="admin-sidebar bg-slate-900 flex flex-col" id="adminSidebar">
  ...
  <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-1">
    ...
    <a href="<?= APP_URL ?>/admin/ekskul" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors <?= strpos($currentPath,'/admin/ekskul') !== false ? 'bg-blue-600 text-white' : 'text-slate-400 hover:bg-slate-800 hover:text-white' ?>"><i class="fas fa-running w-5 text-center"></i>Ekstrakurikuler</a>
    ...
    <a href="<?= APP_URL ?>/admin/settings/homepage" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors <?= strpos($currentPath,'/admin/settings/homepage') !== false ? 'bg-blue-600 text-white' : 'text-slate-400 hover:bg-slate-800 hover:text-white' ?>"><i class="fas fa-home w-5 text-center"></i>Homepage</a>
    <a href="<?= APP_URL ?>/admin/custom-menu" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors <?= strpos($currentPath,'/admin/custom-menu') !== false ? 'bg-blue-600 text-white' : 'text-slate-400 hover:bg-slate-800 hover:text-white' ?>"><i class="fas fa-bars w-5 text-center"></i>Custom Menu</a>
  </nav>
